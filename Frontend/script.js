...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const productosVendedorGrid = document.getElementById('productosVendedorGrid');
  ...
  const listaPresupuestoVendedor = document.getElementById('listaPresupuestoVendedor');
  const totalPresupuestoVendedor = document.getElementById('totalPresupuesto');
