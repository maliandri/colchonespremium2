  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        ...
        {productos.length === 0 && (
          <div className="text-center py-12 text-gray-500">No hay productos creados. Crea uno para empezar.</div>
        )}
      </div>
    </div>
  );
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        setFormData({ ...formData, imagen: response.url, imagenOptimizada: response.optimizedUrl });
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="file" accept="image/*" onChange={handleImageUpload}
                className="w-full border rounded px-3 py-2" disabled={uploading} />
              {uploading && <p className="text-sm text-blue-600 mt-1">Subiendo imagen...</p>}
              {formData.imagen && (
                <img src={formData.imagenOptimizada || formData.imagen} alt="Preview"
            ...
            <div className="flex justify-end space-x-3 pt-4">
              ...
              <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:bg-gray-400" disabled={saving}>
